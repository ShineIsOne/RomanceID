const mangaList = [
  ...
  },
  {
    ...
    "status": "Ongoing",
    "latestChapter": "Vol.1 Ch.1",
    "link": "https://mangadex.org/title/e3c3390b-ed49-4af1-ad42-5f5451727ee3/deochi-mitaina-settei-wo-fuyo-shite-kuru-henshuu-no-aira-senpai",
    "synopsis": "(IDN)\n\"Hari ini kita coba membuat romcom dengan setting 'bisa melihat pakaian menjadi tembus pandang'!\"\n\nDi Klub Penelitian Sastra Sekunder, ketua klub sekaligus calon editor, Takiuchi Aira, mengajak para anggota menyusun berbagai ide romcom yang nyeleneh. Namun, bagi Sasai Sakka yang bercita-cita menjadi penulis, semua setting yang dibuat Aira-senpai tiba-tiba benar-benar menjadi kenyataan, dimulai dari kemampuan melihat pakaian Aira-senpai menjadi tembus pandang.\n\nDengan kekuatan misterius yang membuat setting fiksi berubah menjadi nyata, seorang calon penulis dan calon editor bersama-sama menciptakan berbagai plot romcom dalam kisah komedi romantis dengan konsep yang unik.\n\n(ENG)\n\"Today, let's try a rom-com where people can see through clothes!\"\n\nAt the Secondary Literature Research Club, club president and aspiring editor Takiuchi Aira proposes outrageous rom-com settings for the club to experiment with. But to the aspiring novelist Sasai Sakka, those settings suddenly become reality, starting with Aira-senpai's clothes actually becoming see-through.\n\nAs they use a mysterious power that turns fictional settings into reality, the aspiring writer and aspiring editor work together to create one rom-com plot after another in this fresh romantic comedy.",
    "lang": [
      "id",
      "en"
    ],
  ...
  },
  {
    ...
    "image": "img/d2e5c12a-0d61-44e0-a669-e1d5327b2a56.jpg",
    "genres": [
      "Comedy",
      "Romance",
      "Slice of Life",
